...
if(usuarioLogin =='admin' && senhaLogin =='admin123'){
    alert("Login ADM bem-sucedido!"); 
    window.location.href = 'Cadastro_Animal.html'; 
}

else if(bancoDeDados[usuarioLogin]){   //compara a senha e o usuário digitados com os que estão salvos no banco de dados, caso estejam certo o login é efetuado e o usuário é enviado para a página inicial, caso esteja errado é avisado que algo foi digitado incorretamente.//
